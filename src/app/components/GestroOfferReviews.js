...
const Reviews = () => {
    ...
    <>
      {Array.from({ length: 5 }, (_, i) => (
        <IoMdStar
          key={i}
          className={`h-6 w-6 ${
            i < filledStars ? "fill-[#FFB400] text-[#FFB400]" : "text-gray-300"
          }`}
        />
      ))}
    </>
      ...
      <div className="flex items-start gap-2">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 py-2">
            <div className="font-medium !font-roboto text-sm leading-[22px] text-[#000000DE]">
              {review.name}
            </div>
            <div className="font-medium !font-roboto text-sm leading-[22px] text-[#000000DE]">
              {review.time}
          ...
          <p className="text-[#00000099] text-[15px] leading-[22.5px] tracking-[0.15px] font-normal !font-roboto">
            {review.review}
          </p>
        </div>
      </div>
  ...
  useEffect(() => {
    const swiper = gestroSwiperRef.current?.swiper;
