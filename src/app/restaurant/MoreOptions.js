...
const MoreOptions = () => {
  ...
  const Cuisine = ["Italian", "French", "German", "Chinese"];
  ...
  return (
    ...
    >
      ...
      <Grid item xs={12} md={6}>
        <Box
          sx={{ borderLeft: "1px solid #CCCCCC33", px: 2, bgcolor: "#FFFFFF" }}
        >
          <Typography
            variant="subtitle1"
            sx={{ mb: 2, color: "#000000", fontSize: "18px", fontWeight: 500 }}
          >
            Cuisine Type
          </Typography>
          <TextField
