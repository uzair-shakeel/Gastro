...
const EventSearch = () => {
  ...
  return (
    <Box sx={{ width: '100%', borderRadius: 1, mt: 3 }}>
      ...
      <Grid sx={{ border: '1px solid #CCCCCC33', display: 'flex', alignItems: 'center', gap: "12px", mt: '24px', p: '12px', bgcolor: '#F9F9F9', borderRadius: '4px' }} >
        ...
        <Grid item xs={12} sm={6} md={2}>
          <Button
            fullWidth
            variant="outlined"
            sx={{ width: '161px', textTransform: 'uppercase', bgcolor: "#CCCCCC", border: 'none', height: "56px", color: "#000000B2", fontWeight:"600" }}
          >
            More Options
          </Button>
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={2}>
          <Button
            fullWidth
            variant="contained"
            sx={{ width: '106px', textTransform: 'uppercase', bgcolor: '#821101', height: "56px", color: "#F9F9F9" }}
          >
            Search
          </Button>
        </Grid>
